 ...
 */
class BinaView extends GLSurfaceView {
    private static String TAG = "BinaView";
    private static final boolean DEBUG = false;
    private static AssetManager assetManager;

    public BinaView(Context context, AssetManager manager)
    {
        super(context);
    ...
    public BinaView(Context context, boolean translucent,
    ...
    public boolean onTouchEvent(final MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            BinaLib.touch(event.getRawX(), event.getRawY());
        }
        return true;
    }
